                        ...
                        <form onSubmit={this.onSubmit}>
                            <Collapsible trigger="1. Some students have a background, identity, interest, or talent that is so 
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionOne} onChange={this.onChange.bind(this)} name='questionOne' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="2. The lessons we take from obstacles we encounter can be fundamental to later success. Recount 
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionTwo} onChange={this.onChange.bind(this)} name='questionTwo' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="3. Reflect on a time when you questioned or challenged a belief or idea.
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionThree} onChange={this.onChange.bind(this)} name='questionThree' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="4. Describe a problem you've solved or a problem you'd like to solve. It 
                                                  ...
                                                  a solution. ">
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionFour} onChange={this.onChange.bind(this)} name='questionFour' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="5. Discuss an accomplishment, event, or realization that sparked a period 
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionFive} onChange={this.onChange.bind(this)} name='questionFive' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="6. Describe a topic, idea, or concept you find so engaging that it makes 
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionSix} onChange={this.onChange.bind(this)} name='questionSix' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="7. Share an essay on any topic of your choice. It can be one you've already
                                ...
                                <div className='entryDiv container'>
                                      <textarea defaultValue={essay.questionSeven} onChange={this.onChange.bind(this)} name='questionSeven' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                    ...
                    return(
                        ...
                        <form onSubmit={this.onSubmit}>
                            <Collapsible trigger="1. Some students have a background, identity, interest, or talent that is so 
                                                  ...
                                                  this sounds like you, then please share your story. ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionOne' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="2. The lessons we take from obstacles we encounter can be fundamental to later success. Recount 
                                                  a time when you faced a challenge, setback, or failure. How did it affect you, 
                                                  and what did you learn from the experience?  ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionTwo' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="3. Reflect on a time when you questioned or challenged a belief or idea.
                                                  What prompted your thinking? What was the outcome? ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionThree' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="4. Describe a problem you've solved or a problem you'd like to solve. It 
                                                  can be an intellectual challenge, a research query, an ethical dilemma - 
                                                  ...
                                                  a solution. ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionFour' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="5. Discuss an accomplishment, event, or realization that sparked a period 
                                                  of personal growth and a new understanding of yourself or others. ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionFive' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="6. Describe a topic, idea, or concept you find so engaging that it makes 
                                                  you lose all track of time. Why does it captivate you? What or who do you
                                                  turn to when you want to learn more? ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionSix' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <Collapsible trigger="7. Share an essay on any topic of your choice. It can be one you've already
                                                  written, one that responds to a different prompt, or one of your own design.  ">
                                <div className='entryDiv container'>
                                      <textarea onChange={this.onChange.bind(this)} name='questionSeven' className="textarea" rows="10"></textarea>
                                </div>                 
                            </Collapsible>
                            <div className="control">
                                <button type='submit' className="button is-primary">Submit</button>
